// app/src/main/kotlin/cz/lastaapps/languagetool/ui/features/home/vosk/VoskProcessor.kt

package cz.lastaapps.languagetool.ui.features.home.vosk
...
class VoskProcessor(private val context: Context, private val listener: VoskListener) {
    ...
    fun startListening() {
        if (isListening) {
            Log.w(LOG_TAG, "Vosk: StartListening called but already listening.")
            return
        }
        if (model == null) {
            Log.w(LOG_TAG, "Vosk: StartListening called but model is null.")
            return
        }
        isListening = true
        ...
        Thread {
            try {
                ...
                Log.d(LOG_TAG, "Vosk: AudioRecord started recording.")
                ...
                Log.d(LOG_TAG, "Vosk: Loop finished. Total bytes read: $totalBytesRead")
                ...
                Log.e(LOG_TAG, "Vosk VOSK: Error in listening thread", e)
